...
//
//{
//	String a{ "THIS,Q--A SAMPLE STRING.NOTHING" };
//	cout << "ORIGNAL :" << a << '\n';
//	String token;
//	while (a)
//	{
...
istream& operator>>(istream& y, String& x)
{
	...
	while ((ch = y.get()) != '\n')
	{
		...
		if ((count + 1) == x.getSize())
		{
			x.resize(x.getSize() * 2);
...
//			if (data[j] >= '0' && data[j] <= '9')
//			{
//				decimal = decimal + (div * ((int)data[j] - 48));
//				div = div / 10;
//			}
//			j++;
//		}
//		decimal = decimal / tempDiv;
//		return decimal;
//
//	}
//}
